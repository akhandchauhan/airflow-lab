"""Session 09 · assignment — a two-input mart (orders & refunds).
...
@dag(dag_id="s9_prod_a", schedule="@daily", **COMMON)
def prod_a():
    # TODO: outlets=[orders]
    @task
    def todo() -> None:
...
@dag(dag_id="s9_prod_b", schedule="@daily", **COMMON)
def prod_b():
...
@dag(dag_id="s9_mart", schedule=(orders & refunds), **COMMON)
def mart():
