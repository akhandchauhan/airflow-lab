# Session 09 · Schedules & Intervals
...
| `[Asset(...)]` | data-aware — run when an asset updates (Session 10+) |
...
```bash
python dags/s9/s9_examples.py
airflow dags test s9_examples 2026-01-01
```
...
**File:** `dags/s9/s9_assignment.py`  ·  **dag_id:** `s9_assignment`
...
- `python dags/s9/s9_assignment.py` parses (prints nothing).
- `airflow dags test s9_assignment 2026-01-01` prints an **hour-long** window.
...
```bash
python dags/s9/s9_assignment.py
...
Session 09 in `docs/course/README.md`.
