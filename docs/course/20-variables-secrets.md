...
```bash
python dags/s20/s20_examples.py
...
**File:** `dags/s20/s20_assignment.py` · **dag_id:** `s20_assignment`
...
- `python dags/s20/s20_assignment.py` parses (prints nothing) with **no** `Variable.get` at import time.
...
```bash
python dags/s20/s20_assignment.py
