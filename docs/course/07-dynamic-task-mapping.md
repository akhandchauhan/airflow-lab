# Session 07 · Dynamic Task Mapping
...
@dag(
    dag_id="s7_dynamic_mapping_demo",
    start_date=pendulum.datetime(2026, 1, 1, tz="UTC"),
    schedule=None,
    catchup=False,
    tags=["session-7", "dynamic-mapping"],
...
```bash
python dags/s7/dynamic_mapping_demo.py
airflow dags test s7_dynamic_mapping_demo 2026-01-01
```
...
**File:** `dags/s7/dynamic_mapping.py`  ·  **dag_id:** `s7_dynamic_mapping`
...
- `python dags/s7/dynamic_mapping.py` parses (prints nothing).
- `airflow dags test s7_dynamic_mapping 2026-01-01` runs green.
...
```bash
python dags/s7/dynamic_mapping.py
airflow dags test s7_dynamic_mapping 2026-01-01
