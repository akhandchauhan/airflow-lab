...
@dag(
    dag_id="s8_dynamic_mapping_demo",
...
```bash
python dags/s8/dynamic_mapping_demo.py
airflow dags test s8_dynamic_mapping_demo 2026-01-01
```
...
**File:** `dags/s8/dynamic_mapping.py`  ·  **dag_id:** `s8_dynamic_mapping`
...
- `python dags/s8/dynamic_mapping.py` parses (prints nothing).
- `airflow dags test s8_dynamic_mapping 2026-01-01` runs green.
...
```bash
python dags/s8/dynamic_mapping.py
airflow dags test s8_dynamic_mapping 2026-01-01
