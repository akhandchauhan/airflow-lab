...
```bash
python dags/practicals/p1/bigquery_hello_demo.py
...
**File:** `dags/practicals/p1/bigquery_hello.py`  ·  **dag_id:** `p1_bigquery_hello`
...
- `python dags/practicals/p1/bigquery_hello.py` parses (prints nothing).
...
```bash
python dags/practicals/p1/bigquery_hello.py
