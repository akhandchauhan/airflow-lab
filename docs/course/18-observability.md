...
- `remote_log_conn_id` names the connection used to write (Session 15) — no credential in config.
...
```bash
python dags/s18/s18_examples.py
...
**File:** `dags/s18/s18_assignment.py` · **dag_id:** `s18_assignment`
...
- `python dags/s18/s18_assignment.py` parses (prints nothing).
