...
```bash
python dags/stage-1-basic-dags/s3/task_groups_demo.py
...
**File:** `dags/stage-1-basic-dags/s3/task_groups.py`  ·  **dag_id:** `s3_task_groups`
...
- `python dags/stage-1-basic-dags/s3/task_groups.py` parses (prints nothing).
...
```bash
python dags/stage-1-basic-dags/s3/task_groups.py
