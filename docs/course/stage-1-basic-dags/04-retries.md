# Session 04 · When a Task Falls Over
...
```python
# dags/stage-1-basic-dags/s4/flaky_task_demo.py
...
@dag(
    dag_id="s4_flaky_task_demo",
    start_date=pendulum.datetime(2026, 1, 1, tz="UTC"),
    schedule=None,
    catchup=False,
    tags=["session-4", "retries"],
...
```bash
python dags/stage-1-basic-dags/s4/flaky_task_demo.py
airflow dags test s4_flaky_task_demo 2026-01-01
```
...
**File:** `dags/stage-1-basic-dags/s4/s4_task3.py` (scaffold ready) · **dag_id:** `s4_task3`
...
- `python dags/stage-1-basic-dags/s4/s4_task3.py` parses (prints nothing).
- `airflow dags test s4_task3 2026-01-01` runs green — the logs show at least
...
```bash
python dags/stage-1-basic-dags/s4/s4_task3.py
airflow dags test s4_task3 2026-01-01
