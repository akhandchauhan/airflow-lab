...
**File:** `dags/stage-6-scale/s22/versioning_demo.py` · **dag_id:** `s22_versioning_demo`

```python
# dags/stage-6-scale/s22/versioning_demo.py
...
```bash
python dags/stage-6-scale/s22/versioning_demo.py            # parses cleanly
...
**File:** `dags/stage-6-scale/s22/s22_assignment.py` · **dag_id:** `s22_assignment`
...
- In `dags/stage-6-scale/s22/s22_assignment.py`, build a small **plain** DAG (no BigQuery) that *passes* every integrity gate.
...
- `python dags/stage-6-scale/s22/s22_assignment.py` parses (prints nothing on import).
