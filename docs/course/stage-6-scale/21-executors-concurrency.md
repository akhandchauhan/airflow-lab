...
python dags/stage-6-scale/s21/s21_examples.py
...
**File:** `dags/stage-6-scale/s21/s21_assignment.py` · **dag_id:** `s21_assignment`
...
- `python dags/stage-6-scale/s21/s21_assignment.py` parses (prints nothing).
...
python dags/stage-6-scale/s21/s21_assignment.py
